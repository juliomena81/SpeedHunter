...
def send_email(company: str, target_email: str, score: int) -> bool:
    ...
    <p>I’m John Doe, founder of Marketer. We act as the external, white-label engineering department for growth and performance agencies.</p>
    ...
    <p>Best,<br>John Doe<br>Marketer - Sub-second Landings for Ads<br>
    <a href="https://marketing.com">marketing.com</a></p>
    """
